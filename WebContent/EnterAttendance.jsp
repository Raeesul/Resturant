            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="EnterAttendance.jsp">Enter Attendance</a>
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Enter Attendance</h1>
                ...
                <div class="container-fluid">
						  ...
						  <form action="./Attendance" method="post" class="form-container">
								...
								<div class="row">
								<div class="col-half">
								<h4>No Of Days Attend</h4>
								<div class="input-group input-group-icon">
									<input type="number" name="days" id="days" min="0" max="30" placeholder="0-30" required>
									<div class="input-icon"><i class="fa fa-calendar"></i></div>
								</div>
								</div>
								</div>
								
								<button type="submit"  onclick="noOfDays()" class="submit">Enter</button>
