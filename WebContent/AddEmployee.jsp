            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <form action="./EmployeeRegister" method="post" onsubmit="return enableButton()" class="">
						      ...
						      <h4>Email Address</h4>
						      <div class="input-group input-group-icon">
						        <input type="email" name="email" id="email" placeholder="Email Adress" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" required/>
						      ...
						      <h4>NIC Number</h4>
						      <div class="input-group input-group-icon">
						        <input type="text" name="nic" id="nic" placeholder="NIC" pattern="[0-9]{12}" required/>
						    ...
						    <div class="row">
						      ...
						      <h4>Working Time</h4>
						      <div class="input-group">
						          <input type="radio" name="type" value="Full Time" id="type-full"/>
						          <label for="type-full">Full Time</label>
						          <input type="radio" name="type" value="Part Time" id="type-part"/>
						    ...
						    <h4>Designation</h4>
						        <div class="input-group">
						          <input type="radio" name="desc" value="Manager" id="Manager"/>
						          <label for="Manager">Manager</label>
						          <input type="radio" name="desc" value="Cashier" id="Cashier"/>
						          <label for="Cashier">Cashier</label>
						          <input type="radio" name="desc" value="Trainer" id="Trainer"/>
